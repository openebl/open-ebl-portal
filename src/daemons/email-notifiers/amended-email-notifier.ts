...
export const amendedEmailNotifier: EmailNotifier = async ({ db, service, platform, rec, newStash }) => {
  if (
  ...
  getLogger().info(`Send amended notification email to platform ${platform.id} users`);
