...
export const returnedEBlRecord: components["schemas"]["BillOfLadingRecord"] = {
  allow_actions: [],
  bl: {
    ...
    events: [
      ...
      {
        return: {
          return_by: "did:openebl:d2856f4e-e636-4cf0-9110-fbb45304e614",
          return_to: "did:openebl:3993ace7-eb6c-4a1f-bed8-121643a278c9",
          return_at: "2024-03-13T02:53:02Z",
          note: "returned by XXX",
        },
      },
    ],
